...
params:
  fig1: "Figure 1. Three different trajectories at four times to exemplify the possible relationships or classifications of the data."
  fig2: "Figure 2. Different possibilities of classifying the tracks from the whole data set (a) according to its Fréchet distances (b), according to its slopes (c) or a combination of both (d)."
  fig3: "Figure 3. Set ot 300 example trajectories that tscR package includes to work with."
  fig4: " Figure 4. Two options of how the summarizedexperiment object can be introduced to extract the data matrix for later analysis."
---
...
```{r warning=F, fig.cap=params$fig1, echo=FALSE, fig.align='left'}
a <- c(10, 15, 17, 25)
b <- c(5, 8, 6, 9 )
c <- c(-19, -14, -12, -4)
x <- c(1, 2, 3, 4)
...
```{r echo=FALSE, fig.align='left', fig.cap=params$fig2}
...
```{r echo = F, eval=TRUE, fig.align="left", fig.cap=params$fig3}
...
```{r echo=FALSE, out.width='100%', fig.cap=params$fig4, fig.align='left'}

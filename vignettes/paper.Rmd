---
title: 'tscR: new method for clustering biological time series data'
...
$$
\begin{pmatrix}
[a_1,t_1] & \cdots &  [a_n,t_n] \\ 
\vdots & \ddots& \vdots \\ 
[T_1,t_1] & \cdots & [T_n,t_n]
\end{pmatrix}
$$
donde T es el número total de trayectorias y n el número de timestamps. 

Las pendientes que definen una trayectoria (a) pueden definirse como

$$
S_{a1} = \frac{a_{i+1} - a_{i}}{ t_{i+1} - t_{i} }, \cdots, S_{as} = \frac{a_{n} - a_{n-1}}{ t_{n} - t_{n-1} }
$$
...
\vdots & \ddots& \vdots\\ 
T_1 & \cdots & T_{n-1}
\end{pmatrix} \end{pmatrix} \cdot \begin{pmatrix} 1/t_1 \\ \vdots \\ 1/t_n\end{pmatrix} =
...
Finalmente se computa la matriz de distancias entre pendiente empleando la distancia euclídea para ello. 
Como resultado se obtendría para el ejemplo mostrado las siguientes distancias:
